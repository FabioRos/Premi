...
\newglossaryentry{Slide}{name={Slide}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{MongoDb}{name={MongoDb}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{Php}{name={Php}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{Laravel}{name={Laravel}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{Front-End}{name={Front-End}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{javascript}{name={javascript}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{trait}{name={trait}, description={Software proprietario usato per la modellazione di diagrammi UML.}}
...
\newglossaryentry{ORM}{name={ORM\G}, description={}}

\newglossaryentry{database}{name={database\G}, description={Punto nel tempo che determina importanti traguardi intermedi nello svolgimento del progetto. Indica a che distanza si è dalla fine del progetto.}}
