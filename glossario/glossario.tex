...
\newglossaryentry{javascript}{name={javascript}, description={Linguaggio di programmazione.}}

\newglossaryentry{Front-End}{name={Front-End}, description={Descrizione ambiente di sviluppo lato client.}}
