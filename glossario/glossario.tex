...
\newglossaryentry{baseline}{name={baseline\G}, description={}}

\newglossaryentry{bottom-up}{name={bottom-up\G}, description={Nella progettazione \gls{bottom-up} le parti individuali del sistema sono specificate in dettaglio, e poi connesse tra loro in modo da formare componenti più grandi, a loro volta interconnesse fino a realizzare un sistema completo. Le strategie basate sul flusso informativo \gls{bottom-up} sembrano potenzialmente necessarie e sufficienti, poiché basate sulla conoscenza di tutte le variabili in grado di condizionare gli elementi del sistema.}}
...
\newglossaryentry{Gulpease}{name={Gulpease\G}, description={L'Indice Gulpease è un indice di leggibilità di un testo tarato sulla lingua italiana. Rispetto ad altri ha il vantaggio di utilizzare la lunghezza delle parole in lettere anziché in sillabe, semplificandone il calcolo automatico.}}
...
\newglossaryentry{slack}{name={slack\G}, description={}}
