...
\newglossaryentry{integrazione continua}{name={integrazione continua\G}, description={integrazione continua.}}

\newglossaryentry{PHP}{name={PHP\G}, description={software back-end.}}

\newglossaryentry{verbali}{name={verbali\G}, description={Documento che contiene una verbalizzazione consistente nella narrazione per iscritto, in maniera sintetica ma fedele, fatta dalla persona incaricata, di dichiarazioni, operazioni o altri fatti avvenuti in sua presenza, allo scopo di ricordarli e costituirne prova.}}

\newglossaryentry{caso d'uso}{name={caso d'uso\G}, description={Per parlare.}}

\newglossaryentry{Google Hangouts}{name={Google Hangouts\G}, description={Per parlare.}}

\newglossaryentry{Chart.js}{name={Chart.js\G}, description={Generare grafici.}}

\newglossaryentry{framework}{name={framework\G}, description={something else.}}

\newglossaryentry{Angular}{name={Angular.js\G}, description={Basato su javascript.}}

\newglossaryentry{Astah}{name={Astah\G}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{astah}{name={Astah\G}, description={Software proprietario usato per la modellazione di diagrammi UML.}}

\newglossaryentry{back-end}{name={back-end\G}, description={back-end.}}
...
\newglossaryentry{front-end}{name={front-end\G}, description={front-end.}}
...
\newglossaryentry{indici di Gulpease}{name={indici di Gulpease\G}, description={L'Indice Gulpease è un indice di leggibilità di un testo tarato sulla lingua italiana. Rispetto ad altri ha il vantaggio di utilizzare la lunghezza delle parole in lettere anziché in sillabe, semplificandone il calcolo automatico.}}
...
\newglossaryentry{HTML}{name={HTML\G}, description={Linguaggio di markup per la strutturazione delle pagine web.}}
...
\newglossaryentry{Laravel}{name={Laravel\G}, description={}}
...
\newglossaryentry{Skype}{name={Skype\G}, description={}}
...
\newglossaryentry{W3C}{name={W3C\G}, description={}}
