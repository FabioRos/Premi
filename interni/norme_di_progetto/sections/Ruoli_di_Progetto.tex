...
\begin{itemize}
	\item Assicurarsi che le attività di verifica e validazione vengano svolte sistematicamente seguendo le \textit{Norme di Progetto v3.0.0};
	\item Garantire che vengano rispettati i ruoli e le competenze assegnate nel \textit{Piano di Progetto v3.0.0};
...
\begin{itemize}
	\item Agevolare le attività richieste dalle \textit{Norme di Progetto v3.0.0};
