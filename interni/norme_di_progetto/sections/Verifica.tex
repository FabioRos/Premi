...
\end{itemize}
	...
	\paragraph{Test}
		...
		\begin{quote}
			\centering{I test di unità possono essere identificati grazie alla seguente sintassi:}\\
			\centering{\textbf{TU[codice test]}}
		\end{quote}
		...
		\begin{quote}
			\centering{I test di integrazione possono essere identificati grazie alla seguente sintassi:}\\
			\centering{\textbf{TI[identificativo del componente]}}\\
			\centering{Tale identificativo corrisponde al componente i cui elementi sono integrati.}
		\end{quote}
		...
		\begin{quote}
			\centering{I test di sistema possono essere identificati grazie alla seguente sintassi:}\\
			\centering{\textbf{TS[tipo requisito][codice requisito]}}\\
			\centering{ll tipo e il codice si riferiscono al requisito di cui verrà testato il soddisfacimento.}
		\end{quote}
		...
		\begin{quote}
			\centering{I test di sistema possono essere identificati grazie alla seguente sintassi:}\\
			\centering{\textbf{TA[tipo requisito][codice requisito]}}\\
			\centering{ll tipo e il codice si riferiscono al requisito di cui verrà testato il soddisfacimento.}
		\end{quote}
