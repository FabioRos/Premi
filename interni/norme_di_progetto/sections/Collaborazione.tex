...
\end{itemize}
È vietato utilizzare "git add *" per evitare di includere file nascosti essendo consapevoli dell'esatto contenuto. Ogni commit deve essere corredato di un messaggio che descriva in modo conciso il lavoro svolto.

		\subsubsection{Struttura}
Tutta la documentazione si può trovare in un repository disponibile al seguente indirizzo: \url{https://github.com/FabioRos/Premi}. \\
