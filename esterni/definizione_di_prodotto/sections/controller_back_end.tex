...
\end{figure}
	...
	\paragraph{Metodi}
		\begin{itemize}
			...
			Il metodo effettua il recupero dei dati dell'utente a cui corrisponde la variabile \textit{username} univoca, in particolare il suo profilo, e restituisce un oggetto \gls{JSON} contenente tali informazioni:\\
			\textbf{Argomenti}
			\begin{itemize}
