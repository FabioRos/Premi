I Design Pattern sono un modello da applicare per la risoluzione di problemi ricorrenti. I Design Pattern possono essere organizzati in quattro categorie:
	\begin{itemize}
