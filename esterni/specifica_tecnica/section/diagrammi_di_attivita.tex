...
\begin{figure}[h] 
	\centering 
	\includegraphics[scale=0.3] {img/activity_login.png} 
...
\end{figure}
L'attività di creazione in figura 35 permette ad un utente autenticato di creare un nuovo progetto, di selezionare dove sarà salvato il progetto e richiede di inserire un titolo e di scegliere un template.
\newpage
