...
\end{itemize}
Nel caso in cui il \textit{Verificatore} individui un'anomalia dovrà aprire un ticket di segnalazione. Per la gestione completa di questi problemi si rimanda alla consultazione delle \textit{Norme di Progetto v2.0.0}.
...
Il \textit{ciclo di Deming} è chiamato anche \textit{PDCA} a causa delle quattro fasi che lo compongono:
\begin{itemize}
