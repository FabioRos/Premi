...
tempi.
\subsubsection{2.9.1.1 Schedule Variance (SV)}
...
Essendo stati inseriti \gls{slack} durante la pianificazione della baseline dei processi, il valore di tale indice è inizialmente positivo.
Parametri utilizzati:
\begin{itemize}
	\item Range-accettazione: $\left[  \geq - \: costo \: preventivo \: fase * 5 \% \right]$
	\item Range-ottimale: $\left[\geq 0\right]$.
\end{itemize}
...
Parametri utilizzati:
\begin{itemize}
	\item Range-accettazione: $\left[  \geq - \: costo \: preventivo \: fase * 10 \% \right]$
	\item Range-ottimale: $\left[\geq 0\right]$.
\end{itemize}
