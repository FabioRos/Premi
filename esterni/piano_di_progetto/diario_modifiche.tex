...
\begin{tabular}{|c|p{0.3\textwidth}|c|c|c|}
	...
	\midrule
	\midrule
		v3.0.0 & \textit{Approvazione documento} & Burlin Valerio & \textit{Amministratore di Progetto} & 2015-07-04\\
	\midrule
		v2.2.0 & \textit{Eseguita verifica documento} & Carraro Nicola & \textit{Verificatore} & 2015-07-03\\
	\midrule
		v2.1.2 & \textit{Inserita sottosezione A.2 relativa al rapporto SEMAT corrente del periodo di Progettazione di Dettaglio e Codifca} & Suierica Bogdan & \textit{Responsabile di Progetto} & 2015-07-02\\
	\midrule
		v2.1.1 & \textit{Aggiornata sezione 8 relativa al Consuntivo a Finire} & Suierica Bogdan & \textit{Responsabile di Progetto} & 2015-07-01\\
	\midrule
		v2.1.0 & \textit{Eseguita verifica documento} & Carraro Nicola & \textit{Verificatore} & 2015-06-30\\
	\midrule
		v2.0.4 & \textit{Inserita sottosezione 7.4 relativa al consuntivo corrente del periodo di Progettazione di Dettaglio e Codifca} & Suierica Bogdan & \textit{Responsabile di Progetto} & 2015-06-29\\
	\midrule
		v2.0.3 & \textit{Eseguita modifica alla sezione 2 relativa all'analisi dei rischi ed alle sue sottosezioni} & Suierica Bogdan & \textit{Responsabile di Progetto} & 2015-06-26\\
	\midrule
