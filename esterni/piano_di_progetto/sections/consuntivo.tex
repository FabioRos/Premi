...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|c|}
		...
		\midrule
		Agostinetto Matteo & & & & & +3 & +4 & +7 \\
		Burlin Valerio & & & & & & +1 & +1 \\ 
		Carraro Nicola & & & & & -1 & & -1 \\
		Crespan Emanuele & & & -1 & +8 & +4 & +2 & +13 \\
		Ros Fabio & & & & -1 & -1 & & -2 \\
		Suierica Bogdan & & & & & -1 & & -1 \\
...
\begin{figure}[h]
	...
	\addplot +[bar shift=-.2cm] plot coordinates {(1, 4) (2, 4) (3, 4) (4, 64) (5, 174) (6, 66)};
	
	\addplot +[bar shift=.2cm] plot coordinates {(1, 4) (2, 4) (3, 5) (4, 57) (5, 168) (6, 59)};
	\legend{\strut Ore preventivo, \strut Ore consuntivo}
	\end{axis}
	\end{tikzpicture}
