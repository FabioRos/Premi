...
\newpage
\subsubsection{Diagramma di \gls{Gantt}: Analisi}
\begin{figure}[h] 
	\centering
	\includegraphics[width=\textwidth]{./img/analisi.png}
	\caption{Diagramma di \gls{Gantt} della macro-fase di Analisi}
	\label{fig1}
\end{figure}
...
\subsubsection{Diagramma di \gls{Gantt}: Analisi di Dettaglio}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{./img/analisi_dettaglio.png}
\caption{Diagramma di \gls{Gantt} della macro-fase di Analisi di Dettaglio}
\end{figure}
...
\subsubsection{Diagramma di \gls{Gantt}: Progettazione Architetturale}
\begin{figure}[h] 
	\centering
	\includegraphics[width=\textwidth]{./img/progettazione_architetturale.png}
	\caption{Diagramma di \gls{Gantt} della macro-fase di Progettazione Architetturale}
\end{figure}
...
\begin{figure}[h] 
	...
	\caption{Diagramma di \gls{Gantt} della macro-fase di Progettazione di Dettaglio e Codifica}
\end{figure}
