...
\end{axis}
\end{tikzpicture}
\caption{Ore a componente, fase di Analisi}
\end{figure}
\newpage
...
\end{axis}
\end{tikzpicture}
\caption{Ore a componente, fase di Analisi di Dettaglio}
\end{figure}
\newpage
...
\end{axis}
\end{tikzpicture}
\caption{Ore a componente, fase di Progettazione Architetturale}
\end{figure}
\newpage
...
\end{axis}
\end{tikzpicture}
\caption{Ore a componente, fase di Progettazione di Dettaglio e Codifica}
\end{figure}
\newpage
...
\end{axis}
\end{tikzpicture}
\caption{Ore a componente, fase di Verifica e Validazione}
\end{figure}
\newpage
\subsection{Totale}
...
\noindent I valori sono riassunti nei seguenti grafici che visualizzano le ore totali che un membro ha ricoperto in un determinato ruolo:
...
\noindent e le ore rendicontate che un membro ha ricoperto in un determinato ruolo:
