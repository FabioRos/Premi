...
\begin{axis}[
	...
	\addplot+[ybar,fill = green,draw = black]
	plot coordinates {(Agostinetto Matteo, 14) (Burlin Valerio, 14) (Carraro Nicola, 18) (Crespan Emanuele, 8) (Ros Fabio, 12) (Suierica Bogdan, 10)};
	\legend{\strut Responsabile di Progetto, \strut Amministratore di Progetto, \strut Analista, \strut Progettista, \strut Programmatore, \strut Verificatore}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
	...
	\addplot+[ybar,fill = green,draw = black]
	plot coordinates {(Agostinetto Matteo, 15) (Burlin Valerio, 7) (Carraro Nicola, 13) (Crespan Emanuele, 16) (Ros Fabio, 8) (Suierica Bogdan, 13)};
	\legend{\strut Responsabile di Progetto, \strut Amministratore di Progetto, \strut Analista, \strut Progettista, \strut Programmatore, \strut Verificatore}
\end{axis}
\end{tikzpicture}
