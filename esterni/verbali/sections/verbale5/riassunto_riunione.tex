In questo incontro abbiamo presentato i \gls{casi d'uso} individuati finora nell'\textit{Analisi dei Requisiti} per verificarne la conformità alle richieste ed aspettative del Proponente.
