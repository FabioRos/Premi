\subsection{Caso d'uso UC9: Salvataggio infografica}
\begin{figure}[h] 
	\centering 
...
\subsection{Caso d'uso UC9.1: Selezionare funzione salva}
\begin{itemize}
	\item \textbf{Attori:} Utente;
...
\subsection{Caso d'uso UC9.4: Seleziona file già esistente}
\begin{itemize}
	\item \textbf{Attori:} Utente;
