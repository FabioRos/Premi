...
\end{itemize}
	...
	\begin{itemize}
		\item \textbf{Attori:} Proprietario;
		\item \textbf{Scopo e descrizione:} L'utente deve scegliere il tipo di grafico da inserire tra istogramma, torta e linea;
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item L'utente può impostare il testo normale [UC9.15.4];
		\item L'utente può impostare il testo in corsivo [UC9.15.5];
		\item L'utente può impostare il testo in grassetto [UC9.15.6];
		\item L'utente può spostare il testo in una nuova posizione [UC9.15.7].
	\end{enumerate}
...
\subsection{Caso d'uso UC9.15.4: Impostare stile normale}
\begin{itemize}
	\item \textbf{Attori:} Proprietario;
	\item \textbf{Scopo e descrizione:} L'utente può impostare lo stile del testo normale;
	\item \textbf{Precondizione:} Il testo da modificare è selezionato;
	\item \textbf{Postcondizione:} Il testo è stato modificato secondo la scelta dell'utente.
\end{itemize}

\subsection{Caso d'uso UC9.15.5: Impostare stile corsivo}
\begin{itemize}
	\item \textbf{Attori:} Proprietario;
	\item \textbf{Scopo e descrizione:} L'utente può impostare la scrittura in corsivo;
	\item \textbf{Precondizione:} Il testo da modificare è selezionato;
	\item \textbf{Postcondizione:} Il testo è stato modificato secondo la scelta dell'utente.
\end{itemize}

\subsection{Caso d'uso UC9.15.6: Impostare stile grassetto}
\begin{itemize}
	\item \textbf{Attori:} Proprietario;
	\item \textbf{Scopo e descrizione:} L'utente può impostare la scrittura in grassetto;
	\item \textbf{Precondizione:} Il testo da modificare è selezionato;
	\item \textbf{Postcondizione:} Il testo è stato modificato secondo la scelta dell'utente.
\end{itemize}

\subsection{Caso d'uso UC9.15.7: Posizionare il testo}
\begin{itemize}
	\item \textbf{Attori:} Proprietario;
