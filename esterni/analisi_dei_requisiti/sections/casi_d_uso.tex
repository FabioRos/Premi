Di seguito sono descritti i \gls{casi d'uso} individuati per il progetto \PROGETTO. Ogni caso d'uso\G ha un codice che lo identifica nella forma:
\begin{center}
